...
%\begin{table}[tph]
%\caption{\label{tab:advanced}Advanced Metrics Initial Model}
%\centering
%\begin{threeparttable}
...
%      \hline
%    (Intercept) & 0.2844 & 0.0682 & 4.17 & $<$0.0001 & (0.1503, 0.4184) \\ 
%    A & 0.0903 & 0.0871 & 1.04 & 0.3004 & (-0.0809, 0.2616) \\ 
%    GF & 0.0835 & 0.2150 & 0.39 & 0.6978 & (-0.3392, 0.5063) \\ 
%    Plus-Minus & -0.1309 & 0.0495 & -2.65 & 0.0085 & (-0.2282, -0.0336) \\ 
%    TOI & 1.0859 & 0.3806 & 2.85 & 0.0046 & (0.3375, 1.8343) \\ 
%    iSF & 0.1505 & 0.0800 & 1.88 & 0.0608 & (-0.0068, 0.3077) \\ 
%    Yrs\_in\_NHL & 0.2537 & 0.0293 & 8.65 & <0.0001 & (0.1960, 0.3114) \\ 
%    Wt & 0.0927 & 0.0292 & 3.17 & 0.0016 & (0.0352, 0.1501) \\ 
%    GP & -1.2380 & 0.1479 & -8.37 & <0.0001 & (-1.5289, -0.9470) \\ 
%    PDO & 0.2387 & 0.1320 & 1.81 & 0.0714 & (-0.0209, 0.4983) \\ 
%    CA & 1.2701 & 0.5870 & 2.16 & 0.0311 & (0.1157, 2.4244) \\ 
%    CF & 0.6446 & 0.7586 & 0.85 & 0.3961 & (-0.8473, 2.1364) \\
%    FA & -1.0774 & 0.6302 & -1.71 & 0.0882 & (-2.3167, 0.1619) \\ 
%    FF & 0.2472 & 0.8590 & 0.29 & 0.7737 & (-1.4420, 1.9363) \\ 
%    xGA & -0.1335 & 0.2415 & -0.55 & 0.5807 & (-0.6084, 0.3414) \\ 
%    xGF & -0.6520 & 0.3075 & -2.12 & 0.0347 & (-1.2568, -0.0472) \\ 
%    CA:CF & -0.1448 & 0.4847 & -0.30 & 0.7653 & (-1.0980, 0.8084) \\ 
%    FA:FF & 0.6112 & 0.5099 & 1.20 & 0.2314 & (-0.3915, 1.6139) \\ 
%    CA:FA & -0.5539 & 0.1634 & -3.39 & 0.0008 & (-0.8752, -0.23262936) \\ 
%    CF:FF & -0.4170 & 0.1468 & -2.84 & 0.0047 & (-0.7056, -0.1284) \\ 
%    xGA:xGF & 0.2437 & 0.1832 & 1.33 & 0.1842 & (-0.1165, 0.6038) \\ 
%    PDO:xGA & 0.0339 & 0.1366 & 0.25 & 0.8040 & (-0.2346, 0.3025) \\ 
%    PDO:xGF & 0.1089 & 0.1537 & 0.71 & 0.4789 & (-0.1932, 0.4111) \\ 
%   \bottomrule
%\end{tabular}
%    \begin{tablenotes}
%      \item $R^2_a$ = 0.7161, $df$ = 359, $se$ = 0.5328
%    \end{tablenotes}
%  \end{threeparttable}    
%\end{table}
...
% Remove Std. Error
%\begin{table}[tph]
%\caption{\label{tab:advanced}Advanced Statistics Initial Model (Saturated)}
%\centering
%\begin{threeparttable}
%\begin{tabular}[t]{lrrrrr}
%  \toprule
%  & Estimate & t value & Pr($>$$|$t$|$) & 95\% CI \\
%      \midrule
%    (Intercept) & 0.2844 & 4.17 & $<$0.0001 & (0.1503, 0.4184) \\ 
%    A & 0.0903 & 1.04 & 0.3004 & (-0.0809, 0.2616) \\ 
%    GF & 0.0835  & 0.39 & 0.6978 & (-0.3392, 0.5063) \\ 
%    Plus-Minus & -0.1309 & -2.65 & 0.0085 & (-0.2282, -0.0336) \\ 
%    TOI & 1.0859 & 2.85 & 0.0046 & (0.3375, 1.8343) \\ 
%    iSF & 0.1505 & 1.88 & 0.0608 & (-0.0068, 0.3077) \\ 
%    Yrs\_in\_NHL & 0.2537  & 8.65 & <0.0001 & (0.1960, 0.3114) \\ 
%    Wt & 0.0927 & 3.17 & 0.0016 & (0.0352, 0.1501) \\ 
%    GP & -1.2380 & -8.37 & <0.0001 & (-1.5289, -0.9470) \\ 
%    PDO & 0.2387 & 1.81 & 0.0714 & (-0.0209, 0.4983) \\ 
%    CA & 1.2701 & 2.16 & 0.0311 & (0.1157, 2.4244) \\ 
%    CF & 0.6446 & 0.85 & 0.3961 & (-0.8473, 2.1364) \\
%    FA & -1.0774 & -1.71 & 0.0882 & (-2.3167, 0.1619) \\ 
%    FF & 0.2472 & 0.29 & 0.7737 & (-1.4420, 1.9363) \\ 
%    xGA & -0.1335 & -0.55 & 0.5807 & (-0.6084, 0.3414) \\ 
%    xGF & -0.6520 & -2.12 & 0.0347 & (-1.2568, -0.0472) \\ 
%    CA:CF & -0.1448 & -0.30 & 0.7653 & (-1.0980, 0.8084) \\ 
%    FA:FF & 0.6112  & 1.20 & 0.2314 & (-0.3915, 1.6139) \\ 
%    CA:FA & -0.5539 & -3.39 & 0.0008 & (-0.8752, -0.2326) \\ 
%    CF:FF & -0.4170 & -2.84 & 0.0047 & (-0.7056, -0.1284) \\ 
%    xGA:xGF & 0.2437 & 1.33 & 0.1842 & (-0.1165, 0.6038) \\ 
%    PDO:xGA & 0.0339 & 0.25 & 0.8040 & (-0.2346, 0.3025) \\ 
%    PDO:xGF & 0.1089 & 0.71 & 0.4789 & (-0.1932, 0.4111) \\ 
%   \bottomrule
%\end{tabular}
%    \begin{tablenotes}
%      \item $R^2_a$ = 0.72
...
%\begin{table}
%\centering
%\caption{Basis Dimension Check, Initial GAM} 
%\label{tab.basis.check.initial}
%\begin{tabular}[t]{lrrrr}
%\hline
%& k\textquotesingle & edf & k-index & p-value\\
%\hline
%s(G) & 9.00 & 1.00 & 1.00 & 0.490\\
%s(A) & 9.00 & 1.00 & 1.09 & 0.965\\
%s(GF) & 9.00 & 1.00 & 0.97 & 0.260\\
%s(plus\_mins) & 9.00 & 1.15 & 0.93 & 0.045\\
%s(TOI) & 9.00 & 3.85 & 0.99 &  0.420\\
%s(iSF) & 9.00 & 1.00 & 1.02 & 0.615\\
%s(Yrs\_in\_NHL) & 9.00 & 3.29 & 0.98 & 0.310\\
%s(Wt) & 9.00 & 2.03 & 1.04 & 0.760\\
%s(GP) & 9.00 & 1.00 & 0.96 & 0.195\\
%\hline
%\end{tabular}
%\end{table}
...
%\begin{table}
%\centering
%\caption{Basis Dimension Check, Revised GAM} 
%\label{tab.basis.check.revised}
%\begin{tabular}[t]{lrrrr}
%\hline
%& k\textquotesingle & edf & k-index & p-value\\
%\hline
%s(TOI) & 9.00 & 3.80 & 0.99 &  0.420\\
%s(Yrs\_in\_NHL) & 9.00 & 3.01 & 0.97 & 0.280\\
%\hline
%\end{tabular}
%\end{table}
\vfill\break
